...
** <<category-MIDI>>: Incoming MIDI events.
** <<category-OSC>>: Incoming OSC events.
** <<category-Keyboard>>: incoming PC Keystroke events.
** <<category-REAPER>>: Events that can occur within REAPER.
** <<virtual-source>>: Invocations of virtual control elements (coming from virtual controller mappings). This source
